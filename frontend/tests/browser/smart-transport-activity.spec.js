...
test('all transport mutations use the existing activity allow-list', async () => {
  ...
  for (const action of ['CreateRoute', 'UpdateRoute', 'DeleteRoute', 'RestoreRoute', 'GenerateRoutePath', 'ReorderStops', 'CreateStop', 'UpdateStop', 'DeleteStop', 'RestoreStop']) {
...
test('activity catalog supplies user-friendly Turkish transport descriptions', async () => {
  ...
  for (const label of ['Güzergah oluşturuldu', 'Güzergah güncellendi', 'Güzergah silindi', 'Güzergah geri yüklendi', 'Güzergah rota hesaplama işlemi', 'Durak sırası güncellendi', 'Durak oluşturuldu', 'Durak güncellendi', 'Durak başka güzergaha taşındı', 'Durak konumu güncellendi', 'Durak silindi', 'Durak geri yüklendi']) {
