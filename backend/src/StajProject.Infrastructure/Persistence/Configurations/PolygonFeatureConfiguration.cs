...
public class PolygonFeatureConfiguration : IEntityTypeConfiguration<PolygonFeature>
{
    public void Configure(EntityTypeBuilder<PolygonFeature> builder)
    {
        builder.ToTable("tbl_polygon");
