...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Ayakkabı / Terlik / Çanta
     Slug     : ayakkabi-terlik-canta
     Simge    : shopping-basket
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın ayakkabi-terlik-canta karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_ayakkabi-terlik-canta</Name>
    <UserStyle>
      <Title>POI — Ayakkabı / Terlik / Çanta</Title>
      <Abstract>kategori_slug = 'ayakkabi-terlik-canta' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>ayakkabi-terlik-canta-marker-very-far</Name>
          <Title>Ayakkabı / Terlik / Çanta (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ayakkabi-terlik-canta</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/shopping-basket.svg"/>
        ...
        <Rule>
          <Name>ayakkabi-terlik-canta-marker-medium</Name>
          <Title>Ayakkabı / Terlik / Çanta (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ayakkabi-terlik-canta</ogc:Literal>
        ...
        <Rule>
          <Name>ayakkabi-terlik-canta-marker-near</Name>
          <Title>Ayakkabı / Terlik / Çanta (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ayakkabi-terlik-canta</ogc:Literal>
        ...
        <Rule>
          <Name>ayakkabi-terlik-canta-label</Name>
          <Title>Ayakkabı / Terlik / Çanta ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ayakkabi-terlik-canta</ogc:Literal>
