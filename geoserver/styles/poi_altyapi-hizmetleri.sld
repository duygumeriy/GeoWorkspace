...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Su, Kanalizasyon ve Çöp
     Slug     : altyapi-hizmetleri
     Simge    : recycle
     Renk     : #06B6D4

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın altyapi-hizmetleri karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_altyapi-hizmetleri</Name>
    <UserStyle>
      <Title>POI — Su, Kanalizasyon ve Çöp</Title>
      <Abstract>kategori_slug = 'altyapi-hizmetleri' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>altyapi-hizmetleri-marker-very-far</Name>
          <Title>Su, Kanalizasyon ve Çöp (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>altyapi-hizmetleri</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/recycle.svg"/>
        ...
        <Rule>
          <Name>altyapi-hizmetleri-marker-medium</Name>
          <Title>Su, Kanalizasyon ve Çöp (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>altyapi-hizmetleri</ogc:Literal>
        ...
        <Rule>
          <Name>altyapi-hizmetleri-marker-near</Name>
          <Title>Su, Kanalizasyon ve Çöp (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>altyapi-hizmetleri</ogc:Literal>
        ...
        <Rule>
          <Name>altyapi-hizmetleri-label</Name>
          <Title>Su, Kanalizasyon ve Çöp ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>altyapi-hizmetleri</ogc:Literal>
