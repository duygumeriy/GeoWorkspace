...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Dini Tesisler
     Slug     : dini-tesisler
     Simge    : church
     Renk     : #A855F7

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın dini-tesisler karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_dini-tesisler</Name>
    <UserStyle>
      <Title>POI — Dini Tesisler</Title>
      <Abstract>kategori_slug = 'dini-tesisler' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>dini-tesisler-marker-very-far</Name>
          <Title>Dini Tesisler (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>dini-tesisler</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/church.svg"/>
        ...
        <Rule>
          <Name>dini-tesisler-marker-medium</Name>
          <Title>Dini Tesisler (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>dini-tesisler</ogc:Literal>
        ...
        <Rule>
          <Name>dini-tesisler-marker-near</Name>
          <Title>Dini Tesisler (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>dini-tesisler</ogc:Literal>
        ...
        <Rule>
          <Name>dini-tesisler-label</Name>
          <Title>Dini Tesisler ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>dini-tesisler</ogc:Literal>
