...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Askeri Kurumlar
     Slug     : askeri-kurumlar
     Simge    : shield
     Renk     : #334155

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın askeri-kurumlar karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_askeri-kurumlar</Name>
    <UserStyle>
      <Title>POI — Askeri Kurumlar</Title>
      <Abstract>kategori_slug = 'askeri-kurumlar' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>askeri-kurumlar-marker-very-far</Name>
          <Title>Askeri Kurumlar (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>askeri-kurumlar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/shield.svg"/>
        ...
        <Rule>
          <Name>askeri-kurumlar-marker-medium</Name>
          <Title>Askeri Kurumlar (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>askeri-kurumlar</ogc:Literal>
        ...
        <Rule>
          <Name>askeri-kurumlar-marker-near</Name>
          <Title>Askeri Kurumlar (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>askeri-kurumlar</ogc:Literal>
        ...
        <Rule>
          <Name>askeri-kurumlar-label</Name>
          <Title>Askeri Kurumlar ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>askeri-kurumlar</ogc:Literal>
