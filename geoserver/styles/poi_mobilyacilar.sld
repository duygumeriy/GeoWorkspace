...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Mobilyacılar
     Slug     : mobilyacilar
     Simge    : armchair
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın mobilyacilar karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_mobilyacilar</Name>
    <UserStyle>
      <Title>POI — Mobilyacılar</Title>
      <Abstract>kategori_slug = 'mobilyacilar' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>mobilyacilar-marker-very-far</Name>
          <Title>Mobilyacılar (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>mobilyacilar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/armchair.svg"/>
        ...
        <Rule>
          <Name>mobilyacilar-marker-medium</Name>
          <Title>Mobilyacılar (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>mobilyacilar</ogc:Literal>
        ...
        <Rule>
          <Name>mobilyacilar-marker-near</Name>
          <Title>Mobilyacılar (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>mobilyacilar</ogc:Literal>
        ...
        <Rule>
          <Name>mobilyacilar-label</Name>
          <Title>Mobilyacılar ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>mobilyacilar</ogc:Literal>
