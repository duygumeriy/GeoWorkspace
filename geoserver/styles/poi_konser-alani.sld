...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Konser Alanı
     Slug     : konser-alani
     Simge    : music
     Renk     : #EC4899

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın konser-alani karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_konser-alani</Name>
    <UserStyle>
      <Title>POI — Konser Alanı</Title>
      <Abstract>kategori_slug = 'konser-alani' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>konser-alani-marker-very-far</Name>
          <Title>Konser Alanı (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konser-alani</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/music.svg"/>
        ...
        <Rule>
          <Name>konser-alani-marker-medium</Name>
          <Title>Konser Alanı (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konser-alani</ogc:Literal>
        ...
        <Rule>
          <Name>konser-alani-marker-near</Name>
          <Title>Konser Alanı (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konser-alani</ogc:Literal>
        ...
        <Rule>
          <Name>konser-alani-label</Name>
          <Title>Konser Alanı ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konser-alani</ogc:Literal>
