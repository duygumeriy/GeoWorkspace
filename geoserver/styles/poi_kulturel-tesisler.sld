...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Kültürel Tesisler
     Slug     : kulturel-tesisler
     Simge    : landmark
     Renk     : #A855F7

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın kulturel-tesisler karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_kulturel-tesisler</Name>
    <UserStyle>
      <Title>POI — Kültürel Tesisler</Title>
      <Abstract>kategori_slug = 'kulturel-tesisler' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>kulturel-tesisler-marker-very-far</Name>
          <Title>Kültürel Tesisler (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>kulturel-tesisler</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/landmark.svg"/>
        ...
        <Rule>
          <Name>kulturel-tesisler-marker-medium</Name>
          <Title>Kültürel Tesisler (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>kulturel-tesisler</ogc:Literal>
        ...
        <Rule>
          <Name>kulturel-tesisler-marker-near</Name>
          <Title>Kültürel Tesisler (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>kulturel-tesisler</ogc:Literal>
        ...
        <Rule>
          <Name>kulturel-tesisler-label</Name>
          <Title>Kültürel Tesisler ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>kulturel-tesisler</ogc:Literal>
