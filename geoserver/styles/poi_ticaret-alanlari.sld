...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Ticaret Alanları
     Slug     : ticaret-alanlari
     Simge    : store
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın ticaret-alanlari karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_ticaret-alanlari</Name>
    <UserStyle>
      <Title>POI — Ticaret Alanları</Title>
      <Abstract>kategori_slug = 'ticaret-alanlari' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>ticaret-alanlari-marker-very-far</Name>
          <Title>Ticaret Alanları (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ticaret-alanlari</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/store.svg"/>
        ...
        <Rule>
          <Name>ticaret-alanlari-marker-medium</Name>
          <Title>Ticaret Alanları (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ticaret-alanlari</ogc:Literal>
        ...
        <Rule>
          <Name>ticaret-alanlari-marker-near</Name>
          <Title>Ticaret Alanları (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ticaret-alanlari</ogc:Literal>
        ...
        <Rule>
          <Name>ticaret-alanlari-label</Name>
          <Title>Ticaret Alanları ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>ticaret-alanlari</ogc:Literal>
