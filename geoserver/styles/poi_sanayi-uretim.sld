...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Sanayi ve Üretim Alanları
     Slug     : sanayi-uretim
     Simge    : factory
     Renk     : #334155

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın sanayi-uretim karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_sanayi-uretim</Name>
    <UserStyle>
      <Title>POI — Sanayi ve Üretim Alanları</Title>
      <Abstract>kategori_slug = 'sanayi-uretim' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
