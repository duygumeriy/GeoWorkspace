...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Eğitim Kurumları
     Slug     : egitim-kurumlari
     Simge    : graduation-cap
     Renk     : #F59E0B

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın egitim-kurumlari karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_egitim-kurumlari</Name>
    <UserStyle>
      <Title>POI — Eğitim Kurumları</Title>
      <Abstract>kategori_slug = 'egitim-kurumlari' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>egitim-kurumlari-marker-very-far</Name>
          <Title>Eğitim Kurumları (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>egitim-kurumlari</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/graduation-cap.svg"/>
        ...
        <Rule>
          <Name>egitim-kurumlari-marker-medium</Name>
          <Title>Eğitim Kurumları (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>egitim-kurumlari</ogc:Literal>
        ...
        <Rule>
          <Name>egitim-kurumlari-marker-near</Name>
          <Title>Eğitim Kurumları (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>egitim-kurumlari</ogc:Literal>
        ...
        <Rule>
          <Name>egitim-kurumlari-label</Name>
          <Title>Eğitim Kurumları ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>egitim-kurumlari</ogc:Literal>
