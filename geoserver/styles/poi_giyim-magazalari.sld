...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Giyim Mağazaları
     Slug     : giyim-magazalari
     Simge    : shirt
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın giyim-magazalari karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_giyim-magazalari</Name>
    <UserStyle>
      <Title>POI — Giyim Mağazaları</Title>
      <Abstract>kategori_slug = 'giyim-magazalari' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>giyim-magazalari-marker-very-far</Name>
          <Title>Giyim Mağazaları (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>giyim-magazalari</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/shirt.svg"/>
        ...
        <Rule>
          <Name>giyim-magazalari-marker-medium</Name>
          <Title>Giyim Mağazaları (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>giyim-magazalari</ogc:Literal>
        ...
        <Rule>
          <Name>giyim-magazalari-marker-near</Name>
          <Title>Giyim Mağazaları (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>giyim-magazalari</ogc:Literal>
        ...
        <Rule>
          <Name>giyim-magazalari-label</Name>
          <Title>Giyim Mağazaları ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>giyim-magazalari</ogc:Literal>
