...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Restoran
     Slug     : restoran
     Simge    : utensils-crossed
     Renk     : #F97316

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın restoran karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_restoran</Name>
    <UserStyle>
      <Title>POI — Restoran</Title>
      <Abstract>kategori_slug = 'restoran' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>restoran-marker-very-far</Name>
          <Title>Restoran (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>restoran</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/utensils-crossed.svg"/>
        ...
        <Rule>
          <Name>restoran-marker-medium</Name>
          <Title>Restoran (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>restoran</ogc:Literal>
        ...
        <Rule>
          <Name>restoran-marker-near</Name>
          <Title>Restoran (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>restoran</ogc:Literal>
        ...
        <Rule>
          <Name>restoran-label</Name>
          <Title>Restoran ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>restoran</ogc:Literal>
