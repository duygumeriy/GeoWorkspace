...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Konut Alanları
     Slug     : konut-alanlari
     Simge    : house
     Renk     : #3B82F6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın konut-alanlari karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_konut-alanlari</Name>
    <UserStyle>
      <Title>POI — Konut Alanları</Title>
      <Abstract>kategori_slug = 'konut-alanlari' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>konut-alanlari-marker-very-far</Name>
          <Title>Konut Alanları (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konut-alanlari</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/house.svg"/>
        ...
        <Rule>
          <Name>konut-alanlari-marker-medium</Name>
          <Title>Konut Alanları (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konut-alanlari</ogc:Literal>
        ...
        <Rule>
          <Name>konut-alanlari-marker-near</Name>
          <Title>Konut Alanları (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konut-alanlari</ogc:Literal>
        ...
        <Rule>
          <Name>konut-alanlari-label</Name>
          <Title>Konut Alanları ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>konut-alanlari</ogc:Literal>
