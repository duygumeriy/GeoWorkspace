...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Enerji Üretim ve Dağıtım
     Slug     : enerji-uretim-dagitim
     Simge    : zap
     Renk     : #F59E0B

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın enerji-uretim-dagitim karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_enerji-uretim-dagitim</Name>
    <UserStyle>
      <Title>POI — Enerji Üretim ve Dağıtım</Title>
      <Abstract>kategori_slug = 'enerji-uretim-dagitim' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>enerji-uretim-dagitim-marker-very-far</Name>
          <Title>Enerji Üretim ve Dağıtım (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>enerji-uretim-dagitim</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/zap.svg"/>
        ...
        <Rule>
          <Name>enerji-uretim-dagitim-marker-medium</Name>
          <Title>Enerji Üretim ve Dağıtım (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>enerji-uretim-dagitim</ogc:Literal>
        ...
        <Rule>
          <Name>enerji-uretim-dagitim-marker-near</Name>
          <Title>Enerji Üretim ve Dağıtım (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>enerji-uretim-dagitim</ogc:Literal>
        ...
        <Rule>
          <Name>enerji-uretim-dagitim-label</Name>
          <Title>Enerji Üretim ve Dağıtım ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>enerji-uretim-dagitim</ogc:Literal>
