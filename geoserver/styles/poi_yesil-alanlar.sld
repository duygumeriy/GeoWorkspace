...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Yeşil Alanlar
     Slug     : yesil-alanlar
     Simge    : trees
     Renk     : #22C55E

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın yesil-alanlar karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_yesil-alanlar</Name>
    <UserStyle>
      <Title>POI — Yeşil Alanlar</Title>
      <Abstract>kategori_slug = 'yesil-alanlar' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>yesil-alanlar-marker-very-far</Name>
          <Title>Yeşil Alanlar (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yesil-alanlar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/trees.svg"/>
        ...
        <Rule>
          <Name>yesil-alanlar-marker-medium</Name>
          <Title>Yeşil Alanlar (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yesil-alanlar</ogc:Literal>
        ...
        <Rule>
          <Name>yesil-alanlar-marker-near</Name>
          <Title>Yeşil Alanlar (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yesil-alanlar</ogc:Literal>
        ...
        <Rule>
          <Name>yesil-alanlar-label</Name>
          <Title>Yeşil Alanlar ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yesil-alanlar</ogc:Literal>
