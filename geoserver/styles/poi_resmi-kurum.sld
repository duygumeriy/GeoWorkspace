...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Resmi Kurum
     Slug     : resmi-kurum
     Simge    : building-2
     Renk     : #334155

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın resmi-kurum karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_resmi-kurum</Name>
    <UserStyle>
      <Title>POI — Resmi Kurum</Title>
      <Abstract>kategori_slug = 'resmi-kurum' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>resmi-kurum-marker-very-far</Name>
          <Title>Resmi Kurum (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>resmi-kurum</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/building-2.svg"/>
        ...
        <Rule>
          <Name>resmi-kurum-marker-medium</Name>
          <Title>Resmi Kurum (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>resmi-kurum</ogc:Literal>
        ...
        <Rule>
          <Name>resmi-kurum-marker-near</Name>
          <Title>Resmi Kurum (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>resmi-kurum</ogc:Literal>
        ...
        <Rule>
          <Name>resmi-kurum-label</Name>
          <Title>Resmi Kurum ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>resmi-kurum</ogc:Literal>
