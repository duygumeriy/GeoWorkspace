...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Yapı Marketleri
     Slug     : yapi-marketleri
     Simge    : hammer
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın yapi-marketleri karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_yapi-marketleri</Name>
    <UserStyle>
      <Title>POI — Yapı Marketleri</Title>
      <Abstract>kategori_slug = 'yapi-marketleri' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>yapi-marketleri-marker-very-far</Name>
          <Title>Yapı Marketleri (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yapi-marketleri</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/hammer.svg"/>
        ...
        <Rule>
          <Name>yapi-marketleri-marker-medium</Name>
          <Title>Yapı Marketleri (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yapi-marketleri</ogc:Literal>
        ...
        <Rule>
          <Name>yapi-marketleri-marker-near</Name>
          <Title>Yapı Marketleri (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yapi-marketleri</ogc:Literal>
        ...
        <Rule>
          <Name>yapi-marketleri-label</Name>
          <Title>Yapı Marketleri ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>yapi-marketleri</ogc:Literal>
