...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Önemli Noktalar
     Slug     : onemli-noktalar
     Simge    : map-pin
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın onemli-noktalar karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_onemli-noktalar</Name>
    <UserStyle>
      <Title>POI — Önemli Noktalar</Title>
      <Abstract>kategori_slug = 'onemli-noktalar' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>onemli-noktalar-marker-very-far</Name>
          <Title>Önemli Noktalar (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>onemli-noktalar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/map-pin.svg"/>
        ...
        <Rule>
          <Name>onemli-noktalar-marker-medium</Name>
          <Title>Önemli Noktalar (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>onemli-noktalar</ogc:Literal>
        ...
        <Rule>
          <Name>onemli-noktalar-marker-near</Name>
          <Title>Önemli Noktalar (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>onemli-noktalar</ogc:Literal>
        ...
        <Rule>
          <Name>onemli-noktalar-label</Name>
          <Title>Önemli Noktalar ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>onemli-noktalar</ogc:Literal>
