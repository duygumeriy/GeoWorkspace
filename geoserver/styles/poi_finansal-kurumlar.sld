...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Finansal Kurumlar
     Slug     : finansal-kurumlar
     Simge    : badge-dollar-sign
     Renk     : #06B6D4

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın finansal-kurumlar karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_finansal-kurumlar</Name>
    <UserStyle>
      <Title>POI — Finansal Kurumlar</Title>
      <Abstract>kategori_slug = 'finansal-kurumlar' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>finansal-kurumlar-marker-very-far</Name>
          <Title>Finansal Kurumlar (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>finansal-kurumlar</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/badge-dollar-sign.svg"/>
        ...
        <Rule>
          <Name>finansal-kurumlar-marker-medium</Name>
          <Title>Finansal Kurumlar (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>finansal-kurumlar</ogc:Literal>
        ...
        <Rule>
          <Name>finansal-kurumlar-marker-near</Name>
          <Title>Finansal Kurumlar (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>finansal-kurumlar</ogc:Literal>
        ...
        <Rule>
          <Name>finansal-kurumlar-label</Name>
          <Title>Finansal Kurumlar ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>finansal-kurumlar</ogc:Literal>
