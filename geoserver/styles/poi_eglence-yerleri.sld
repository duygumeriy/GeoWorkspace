...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Eğlence Yerleri
     Slug     : eglence-yerleri
     Simge    : party-popper
     Renk     : #EC4899

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın eglence-yerleri karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_eglence-yerleri</Name>
    <UserStyle>
      <Title>POI — Eğlence Yerleri</Title>
      <Abstract>kategori_slug = 'eglence-yerleri' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>eglence-yerleri-marker-very-far</Name>
          <Title>Eğlence Yerleri (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>eglence-yerleri</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/party-popper.svg"/>
        ...
        <Rule>
          <Name>eglence-yerleri-marker-medium</Name>
          <Title>Eğlence Yerleri (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>eglence-yerleri</ogc:Literal>
        ...
        <Rule>
          <Name>eglence-yerleri-marker-near</Name>
          <Title>Eğlence Yerleri (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>eglence-yerleri</ogc:Literal>
        ...
        <Rule>
          <Name>eglence-yerleri-label</Name>
          <Title>Eğlence Yerleri ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>eglence-yerleri</ogc:Literal>
