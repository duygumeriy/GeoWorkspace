...
<!-- GENERATED FILE — DO NOT EDIT MANUALLY
     ...
     Kategori : Zincir Marketler
     Slug     : zincir-marketler
     Simge    : shopping-cart
     Renk     : #8B5CF6

     ÖDEV ŞARTI: "Her bir POI kategorisi için GeoServer'da ayrı bir
     Style (SLD)". Bu dosya o şartın zincir-marketler karşılığıdır.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_zincir-marketler</Name>
    <UserStyle>
      <Title>POI — Zincir Marketler</Title>
      <Abstract>kategori_slug = 'zincir-marketler' POI'leri; yakın ölçekte isim etiketi.</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <Name>zincir-marketler-marker-very-far</Name>
          <Title>Zincir Marketler (çok uzak)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>zincir-marketler</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="./icons/shopping-cart.svg"/>
        ...
        <Rule>
          <Name>zincir-marketler-marker-medium</Name>
          <Title>Zincir Marketler (orta)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>zincir-marketler</ogc:Literal>
        ...
        <Rule>
          <Name>zincir-marketler-marker-near</Name>
          <Title>Zincir Marketler (yakın)</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>zincir-marketler</ogc:Literal>
        ...
        <Rule>
          <Name>zincir-marketler-label</Name>
          <Title>Zincir Marketler ismi</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>kategori_slug</ogc:PropertyName>
              <ogc:Literal>zincir-marketler</ogc:Literal>
